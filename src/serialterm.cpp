...
SerialTerm::SerialTerm(QWidget *parent , QString comName , QSettings *settings):
...
void SerialTerm::on_receivedData(QString data)
{
...
void SerialTerm::setLogFilename(QString filename)
{
...
void SerialTerm::logToFile(QString lineToBelogged)
{
...
void SerialTerm::activateUrl(const QUrl &url, bool fromContextMenu) {
  /*TODO:   activateUrl
